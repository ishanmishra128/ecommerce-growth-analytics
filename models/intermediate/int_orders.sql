...
order_rollup as (
    select
        ...
        array_agg(traffic_source ignore nulls order by event_timestamp asc limit 1)[safe_offset(0)] as order_source,
        array_agg(traffic_medium ignore nulls order by event_timestamp asc limit 1)[safe_offset(0)] as order_medium,
        array_agg(traffic_campaign ignore nulls order by event_timestamp asc limit 1)[safe_offset(0)] as order_campaign,
